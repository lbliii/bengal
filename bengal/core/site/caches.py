"""
Page caches mixin for Site.

Provides cached properties for page collections and cache management methods.
"""
...
class SiteCachesMixin:
    """
    Mixin providing page cache management for Site.

    Provides cached properties for common page collections (regular_pages,
    generated_pages, listable_pages) and methods to invalidate caches.
    """
