"""
Content and asset discovery mixin for Site.

Provides methods for discovering pages, sections, and assets.
"""
...
class SiteDiscoveryMixin:
    """
    Mixin providing content and asset discovery for Site.

    Discovers pages, sections, and assets from the content/ and assets/
    directories, sets up references, and applies cascades.
    """
    ...
    # - register_sections(): from SiteSectionRegistryMixin
    # - build_cascade_snapshot(): from SiteCascadeMixin
