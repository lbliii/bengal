...
Provides methods for loading data from the data/ directory.
"""
...
class SiteDataMixin:
    """
    Mixin providing data directory loading for Site.

    Loads YAML, JSON, and TOML files from the data/ directory into
    site.data for template access.
    """
