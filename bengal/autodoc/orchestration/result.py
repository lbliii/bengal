...
class AutodocRunResult:
    ...
    autodoc_dependencies: dict[str, dict[str, str]] = field(default_factory=dict)
    """Mapping of source file paths to {page_path: content_hash} mappings.
    ...
    def add_dependency(
        ...
        Args:
            ...
            content_hash: Optional content hash of the documentation elements
        """
        if source_file not in self.autodoc_dependencies:
            self.autodoc_dependencies[source_file] = {}
        self.autodoc_dependencies[source_file][page_path] = content_hash or ""
