...
class TaxonomyOrchestrator:
    ...
    def generate_dynamic_pages(self) -> None:
        ...
        archive_count = sum(1 for p in self.site.pages if p.metadata.get('_generated') and p.metadata.get('template') == 'archive.html')
    ...
    def _create_archive_pages(self, section: 'Section') -> List['Page']:
        ...
        Args:
            section: Section to create archive pages for
            
        Returns:
            List of generated archive pages
        """
        from bengal.core.page import Page
        ...
        for page_num in range(1, paginator.num_pages + 1):
            ...
            # Set output path
            if page_num == 1:
                archive_page.output_path = self.site.output_dir / section.name / "index.html"
            else:
                archive_page.output_path = self.site.output_dir / section.name / f"page/{page_num}/index.html"
