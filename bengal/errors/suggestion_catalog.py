"""Static catalog of actionable error suggestions.

Data-only module: ``ActionableSuggestion`` records keyed by category and error
key. Lookup helpers live in ``bengal.errors.suggestions``.
"""
...
SUGGESTIONS: dict[str, dict[str, ActionableSuggestion]] = {
    # ============================================================
    # Directive errors
    # ============================================================
    "directive": {
