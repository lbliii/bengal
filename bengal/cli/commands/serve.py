...
@click.option('--verbose', '-v', is_flag=True, help='Show detailed server activity (file watches, rebuilds, HTTP details)')
@click.option('--debug', is_flag=True, help='Show debug output and full tracebacks (port checks, PID files, observer setup)')
