...
class InputRecord:
    ...
    path: str        # Relative path or config key
    hash: ContentHash
...
class Provenance:
    ...
    def with_input(self, input_type: str, path: str, content_hash: ContentHash) -> Provenance:
...
class ProvenanceRecord:
    ...
    def from_dict(cls, data: dict[str, Any]) -> ProvenanceRecord:
        ...
        inputs = frozenset(
            InputRecord(inp["type"], inp["path"], ContentHash(inp["hash"]))
