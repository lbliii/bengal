...
Example:
    >>> from bengal.rendering.template_functions.navigation_models import BreadcrumbItem
    >>>
...
class NavTreeItem:
    ...
    Attributes:
        ...
        is_section: True if this represents a section (vs regular page)
        depth: Nesting level (0 = top level)
        children: List of child NavTreeItem objects
        has_children: Boolean shortcut for len(children) > 0

    Example (Jinja template with macro):
