...
if TYPE_CHECKING:
    ...
    from bengal.rendering.parsers.patitas.renderers.utils import HeadingInfo
...
class HtmlRendererProtocol(Protocol):
    ...
    def _render_list_item(
        self, item: Any, sb: StringBuilder, tight: bool
    ) -> None: ...
    ...
    def _render_highlighted_tokens(
        self, tokens: Any, language: str, sb: StringBuilder
    ) -> None: ...
