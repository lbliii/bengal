...
Usage:
    from bengal.utils.actionable_errors import get_suggestion, enhance_error_context

    # Get suggestion for a specific error pattern
    suggestion = get_suggestion("directive", "since_empty")

    # Enhance existing error context with suggestion
    context = {"error": "...", "path": "..."}
...
_SUGGESTIONS: dict[str, dict[str, tuple[str, str, str | None]]] = {
    ...
    "directive": {
        ...
        "glossary_parse_error": (
            ...
            "Glossary files must be valid YAML with 'terms' list containing 'term' and 'definition' keys.",
