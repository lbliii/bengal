...
**Key Changes**:
- 🏷️ Add `isAutodoc: true` flag to search index for autodoc pages
- 📊 Group search results into "Documentation" and "API Reference" sections
- 🔽 Collapse API Reference section by default with result count badge
- ⚙️ Configuration options for customization
...
```
┌─────────────────┐     ┌──────────────────┐     ┌─────────────────┐
│ Index Generator │────▶│   index.json     │────▶│   Search JS     │
│ (Python)        │     │ + isAutodoc flag │     │ + groupResults  │
└─────────────────┘     └──────────────────┘     └─────────────────┘
                                                         │
                                                         ▼
                                                 ┌─────────────────┐
