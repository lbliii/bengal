...
latest tests migrated more section page fixtures through SourcePage helpers. Sprint
...
30, all but the adapter in tests. Deletion remains blocked by the adapter
...
`bengal/` + `tests/` sweep now finds 30 direct import sites, all but the
