...
latest tests migrated more utility and template fixtures through SourcePage helpers. Sprint
...
50, all but the adapter in tests. Deletion remains blocked by the adapter
...
`bengal/` + `tests/` sweep now finds 50 direct import sites, all but the
