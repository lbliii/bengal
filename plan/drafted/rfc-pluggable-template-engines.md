...
**Depends On**: [RFC: Patitas](rfc-patitas.md)

---

## Executive Summary

This RFC proposes a **pluggable template engine architecture** for Bengal that enables users to choose between Jinja2 (default) and [Patitas](rfc-patitas.md) — a new Python-native templating library.
...
- [RFC: patitas](rfc-patitas.md) — Underlying templating library
