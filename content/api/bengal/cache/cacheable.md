...
title: "cacheable"
type: "python-module"
source_file: "bengal/bengal/cache/cacheable.py"
line_number: 1
description: "Cacheable Protocol - Type-safe cache contracts for Bengal. This module defines a Protocol that cacheable types can implement to ensure type-safe serialization and deserialization. Any type that needs ..."
---

# cacheable
**Type:** Module
**Source:** [View source](https://github.com/lbliii/bengal/blob/main/bengal/bengal/cache/cacheable.py#L1)



**Navigation:**
[bengal](/api/bengal/) ›[cache](/api/bengal/cache/) ›cacheable
...
**Inherits from:**`Protocol`Protocol for types that can be cached to disk.
...
---
*Generated by Bengal autodoc from `bengal/bengal/cache/cacheable.py`*
