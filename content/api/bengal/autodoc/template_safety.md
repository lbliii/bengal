...
type: "python-module"
source_file: "bengal/bengal/autodoc/template_safety.py"
line_number: 1
description: "Safe template rendering system with Hugo-style error boundaries. This module provides error-safe template rendering that prevents silent failures and provides graceful fallbacks when templates encount..."
---

# template_safety
**Type:** Module
**Source:** [View source](https://github.com/lbliii/bengal/blob/main/bengal/bengal/autodoc/template_safety.py#L1)
...
---
*Generated by Bengal autodoc from `bengal/bengal/autodoc/template_safety.py`*
