...
title: "badges"
type: "python-module"
source_file: "bengal/bengal/rendering/plugins/badges.py"
line_number: 1
description: "Badge plugin for Mistune. Provides badge syntax: {bdg-color}`text` Supports badge colors that map to Bengal\'s design system."
---

# badges
**Type:** Module
**Source:** [View source](bengal/bengal/rendering/plugins/badges.py#L1)



**Navigation:**
[bengal](/api/bengal/) ›[rendering](/api/bengal/rendering/) ›[plugins](/api/bengal/rendering/plugins/) ›badges
...
---
*Generated by Bengal autodoc from `bengal/bengal/rendering/plugins/badges.py`*
