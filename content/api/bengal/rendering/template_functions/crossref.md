...
line_number: 1
description: "Cross-reference functions for templates. Provides 4 functions for cross-referencing pages and headings with O(1) performance."
---

# crossref
**Type:** Module
**Source:** [View source](bengal/rendering/template_functions/crossref.py#L1)
...
---
*Generated by Bengal autodoc from `bengal/rendering/template_functions/crossref.py`*
