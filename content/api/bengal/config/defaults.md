...
line_number: 1
description: "Single source of truth for all Bengal configuration defaults. All config access should use these defaults via get_default() or specialized helpers like get_max_workers(). This module avoids importing ..."
---
