...
title: "server"
type: "python-module"
source_file: "bengal/bengal/server/__init__.py"
line_number: 1
description: "Development server for Bengal SSG. Provides a local HTTP server with file watching and automatic rebuilds for a smooth development experience. Components: - DevServer: Main development server with HTT..."
---

# server
**Type:** Module
**Source:** [View source](https://github.com/lbliii/bengal/blob/main/bengal/bengal/server/__init__.py#L1)



**Navigation:**
[bengal](/api/bengal/) ›server
...
---
*Generated by Bengal autodoc from `bengal/bengal/server/__init__.py`*
