...
line_number: 1
description: "Content discovery - finds and organizes pages and sections. Robustness: - Symlink loop detection via inode tracking to prevent infinite recursion - Content collection validation (opt-in via collection..."
---

# content_discovery
**Type:** Module
**Source:** [View source](bengal/discovery/content_discovery.py#L1)
...
---
*Generated by Bengal autodoc from `bengal/discovery/content_discovery.py`*
