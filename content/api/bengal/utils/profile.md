...
# profile
**Type:** Module
**Source:** [View source](bengal/utils/profile.py#L1)
...
| `debug` | `bool` | `False` | --debug flag (debug logging, maps to DEVELOPER profile) |
...
---
*Generated by Bengal autodoc from `bengal/utils/profile.py`*
