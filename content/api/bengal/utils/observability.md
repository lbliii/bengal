...
title: "observability"
type: "python-module"
source_file: "bengal/bengal/utils/observability.py"
line_number: 1
...
# observability
**Type:** Module
**Source:** [View source](bengal/bengal/utils/observability.py#L1)
...
`float` - Percentage of cache hits, or 0.0 if no cache operations.
...
`float` - Percentage of items skipped, or 0.0 if no items.
...
---
*Generated by Bengal autodoc from `bengal/bengal/utils/observability.py`*
