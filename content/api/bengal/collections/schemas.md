...
title: "schemas"
type: "python-module"
source_file: "bengal/bengal/collections/schemas.py"
line_number: 1
...
# schemas
**Type:** Module
**Source:** [View source](bengal/bengal/collections/schemas.py#L1)
...
Defined at line 217 in `bengal/bengal/collections/schemas.py`
...
Defined at line 218 in `bengal/bengal/collections/schemas.py`
...
Defined at line 219 in `bengal/bengal/collections/schemas.py`
...
| `author` | - | *No description provided.* |
| `tags` | - | *No description provided.* |
...
| `tags` | - | *No description provided.* |
| `toc` | - | *No description provided.* |
| `description` | - | *No description provided.* |
| `deprecated` | - | *No description provided.* |
| `since` | - | *No description provided.* |
...
| `deprecated` | - | *No description provided.* |
| `auth_required` | - | *No description provided.* |
| `rate_limit` | - | *No description provided.* |
| `description` | - | *No description provided.* |
...
| `date` | - | *No description provided.* |
| `version` | - | *No description provided.* |
| `breaking` | - | *No description provided.* |
| `draft` | - | *No description provided.* |
...
|:-----|:-----|:------------|
| `title` | - | *No description provided.* |
| `difficulty` | - | *No description provided.* |
| `duration` | - | *No description provided.* |
| `prerequisites` | - | *No description provided.* |
| `tags` | - | *No description provided.* |
| `series` | - | *No description provided.* |
| `order` | - | *No description provided.* |



---
*Generated by Bengal autodoc from `bengal/bengal/collections/schemas.py`*
