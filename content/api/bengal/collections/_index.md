...
title: "collections"
type: "python-module"
source_file: "bengal/bengal/collections/__init__.py"
line_number: 1
...
# collections
**Type:** Module
**Source:** [View source](bengal/bengal/collections/__init__.py#L1)
...
| `directory` | - | Directory containing collection content (relative to content root). Required for local content, optional when using a remote loader. |
...
| `loader` | - | Optional ContentSource for remote content (Content Layer). When provided, content is fetched from the remote source instead of the local directory. Install extras: pip install bengal[github] |
...
---
*Generated by Bengal autodoc from `bengal/bengal/collections/__init__.py`*
