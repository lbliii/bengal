...
class HtmlFormatter:
    ...
    Attributes:
        ...
        palette: Optional palette name or SyntaxPalette for theming.
    """
    ...
    def get_stylesheet(self) -> str:
        ...
        """
        from rosettes.themes import generate_css, get_palette

        if self.palette is None:
            return generate_css(css_class_style=self.css_class_style)

        palette_obj = get_palette(self.palette) if isinstance(self.palette, str) else self.palette
        return generate_css(palette_obj, css_class_style=self.css_class_style)
    ...
    def format_fast(
        ...
        if prefix and not is_semantic:
            ...
            span_open = {
                k: f'<span class="{prefix}{v.split(">")[0].split('"')[1]}">'
