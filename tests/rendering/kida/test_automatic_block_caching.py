...
""")
        ...
        result = template.render(
            site={"pages": []}, page={"title": "Test Page"}, _cached_blocks={"nav": cached_html}
        )
...
""")
        ...
        result = template.render(page={"title": "Page Title"}, _cached_blocks={"nav": cached_html})
...
""",
        ...
        result = child_template.render(
            page={"title": "Child Page"}, _cached_blocks={"nav": cached_nav}
        )
...
""")
        ...
        cached_blocks = {"nav": "<nav>Cached Nav</nav>", "footer": "<footer>Cached Footer</footer>"}

        # Render to trigger wrapper creation
        result = template.render(_cached_blocks=cached_blocks)
...
""")
        ...
        result = template.render(
            range=range, page={"title": "Test"}, _cached_blocks={"nav": cached_nav}
        )
...
""")
        ...
        # Render with cached block
        result = template.render(site={"title": "New Site"}, _cached_blocks={"nav": cached_html})
