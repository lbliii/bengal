...
class TestGetBreadcrumbs:
    ...
    def test_basic_breadcrumbs(self):
        ...
        page._path = "/docs/getting-started/"
        ...
        assert len(result) == 2
        assert result[0] == {"title": "Docs", "href": "/docs/", "is_current": False}
        assert result[1] == {
    ...
    def test_nested_breadcrumbs(self):
        ...
        markdown._path = "/docs/markdown/"

        page = Mock()
        page.ancestors = [markdown, docs]  # Closest ancestor first
        page._path = "/docs/markdown/syntax/"
        page.title = "Syntax"
    ...
    def test_section_index_page_no_duplication(self):
        ...
        page._path = "/docs/markdown/"  # Same URL as last ancestor
        page.title = "Markdown"
    ...
    def test_all_items_have_required_fields(self):
        """All breadcrumb items have title, href, and is_current."""
        section = Mock()
        section.title = "Docs"
        section._path = "/docs/"
    ...
    def test_deeply_nested_truncates_to_2_ancestors(self):
        ...
        level1 = Mock()
        level1.title = "Level1"
        level1._path = "/root/level1/"

        level2 = Mock()
        level2.title = "Level2"
        level2._path = "/root/level1/level2/"

        level3 = Mock()
        level3.title = "Level3"
        level3._path = "/root/level1/level2/level3/"

        page = Mock()
        page.ancestors = [level3, level2, level1, root]  # Closest ancestor first
        page._path = "/root/level1/level2/level3/page/"
        page.title = "Page"
