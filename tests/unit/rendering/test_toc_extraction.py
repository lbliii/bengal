...
<li><a href="#installation">Installation</a></li>
        ...
        assert len(items) == 3
        assert items[0] == TOCItem(id="overview", title="Overview", level=1)
        assert items[1] == TOCItem(id="features", title="Features", level=1)
        assert items[2] == TOCItem(id="installation", title="Installation", level=1)
...
<li><a href="#features">Features</a></li>
  ...
  <li><a href="#flexible">Flexible</a></li>
        ...
        assert len(items) == 6
        assert items[0] == TOCItem(id="overview", title="Overview", level=1)
        assert items[1] == TOCItem(id="what-is-it", title="What is it?", level=2)
        assert items[2] == TOCItem(id="why-use-it", title="Why use it?", level=2)
        assert items[3] == TOCItem(id="features", title="Features", level=1)
        assert items[4] == TOCItem(id="fast", title="Fast", level=2)
        assert items[5] == TOCItem(id="flexible", title="Flexible", level=2)
...
<li><a href="#only">Only Heading</a></li>
        ...
        assert len(items) == 1
        assert items[0] == TOCItem(id="only", title="Only Heading", level=1)
