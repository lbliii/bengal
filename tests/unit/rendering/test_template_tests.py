...
from bengal.rendering.template_tests import (
    register,
    test_draft,
    test_featured,
    test_outdated,
...
class TestOutdatedTest:
    ...
    def test_page_older_than_default_days(self):
        ...
        assert test_outdated(page) is True
    ...
    def test_page_newer_than_default_days(self):
        ...
        assert test_outdated(page) is False
    ...
    def test_custom_days_threshold(self):
        ...
        assert test_outdated(page, days=30) is True

        # 40 days old, threshold 50 -> not outdated
        assert test_outdated(page, days=50) is False
    ...
    def test_zero_days_threshold(self):
        ...
        # 1 day old > 0 days
        assert test_outdated(page, days=0) is True
...
class TestSectionTest:
    ...
    def test_section_object(self):
        ...
        assert test_section(section) is True

    def test_non_section_object(self):
        """Test non-Section objects."""
        page = MockPage(name="page")
        assert test_section(page) is False

    def test_dict_object(self):
        """Test dict object."""
        data = {"name": "blog"}
        assert test_section(data) is False

    def test_none(self):
        """Test None value."""
        assert test_section(None) is False

    def test_string(self):
        """Test string value."""
        assert test_section("blog") is False

    def test_list(self):
        """Test list value."""
        assert test_section([]) is False
