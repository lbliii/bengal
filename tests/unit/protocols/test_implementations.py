...
class TestProgressReporterImplementations:
    ...
    def test_live_progress_adapter_satisfies_protocol(self) -> None:
        ...
        class MockProgressManager:
            def add_phase(self, phase_id, label, total=None):
                pass

            def start_phase(self, phase_id):
                pass

            def update_phase(self, phase_id, **kwargs):
                pass

            def complete_phase(self, phase_id, elapsed_ms=None):
                pass
...
class TestCacheableImplementations:
    ...
    def test_page_core_satisfies_cacheable(self) -> None:
        ...
        # Runtime protocol check
        assert isinstance(core, Cacheable), "PageCore does not satisfy Cacheable protocol"
