...
def site_with_links(tmp_path):
    ...
    hub = _page(
        source_path=tmp_path / "hub.md", raw_content="# Hub Page", metadata={"title": "Hub"}
    )
...
class TestFormatStats:
    ...
    def test_format_stats_no_orphans(self, tmp_path):
        ...
        page1 = _page(source_path=tmp_path / "p1.md", raw_content="", metadata={"title": "Page 1"})
        page2 = _page(source_path=tmp_path / "p2.md", raw_content="", metadata={"title": "Page 2"})
