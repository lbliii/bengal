...
class TestJsonCompatDumps:
    ...
    def test_dumps_basic(self):
        ...
        from bengal.utils.io.json_compat import dumps
...
class TestJsonCompatLoads:
    ...
    def test_loads_basic(self):
        ...
        from bengal.utils.io.json_compat import loads
    ...
    def test_loads_invalid_json(self):
        ...
        from bengal.utils.io.json_compat import JSONDecodeError, loads
...
class TestJsonCompatDump:
    ...
    def test_dump_basic(self, tmp_path):
        ...
        from bengal.utils.io.json_compat import dump
...
class TestJsonCompatLoad:
    ...
    def test_load_basic(self, tmp_path):
        """Test JSON file read."""
        from bengal.utils.io.json_compat import load
    ...
    def test_load_invalid_json(self, tmp_path):
        ...
        from bengal.utils.io.json_compat import JSONDecodeError, load
...
class TestJsonCompatRoundtrip:
    ...
    def test_roundtrip_complex_data(self, tmp_path):
        ...
        from bengal.utils.io.json_compat import dump, load
