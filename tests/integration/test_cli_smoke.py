...
CLI_SMOKE_CASES = [
    ...
    CLISmokeCase(("capability", "list")),
    CLISmokeCase(("capability", "info", "--name", "mermaid"), acceptable_exit_codes=(0, 1)),
    CLISmokeCase(("capability", "validate"), acceptable_exit_codes=(0, 1)),
    ...
    CLISmokeCase(("debug", "includes", "--page-path", "index")),
