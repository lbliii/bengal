...
:::{note}
This is legacy documentation for Bengal v1.0. For the latest features and improvements, see the [[docs/|current documentation]].
:::
...
- **Jinja2 templates** for theming
- **Basic CLI** for building and serving
