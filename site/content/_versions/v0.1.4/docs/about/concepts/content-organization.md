...
Want to catch frontmatter errors at build time? Use [[docs/build-sites/structure/collections|Content Collections]] to define schemas that validate your content automatically. Collections are optional but helpful for teams or sites with strict content requirements.
