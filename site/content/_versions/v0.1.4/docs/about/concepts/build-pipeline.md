...
*   **Schema Validation**: If `collections.py` exists, frontmatter is validated against defined schemas (see [[docs/build-sites/structure/collections|Content Collections]]).
...
See [[/core/pipeline|Reactive Pipeline Architecture]] for details.
