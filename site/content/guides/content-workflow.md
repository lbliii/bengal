...
description: Set up an efficient workflow for creating, reviewing, and publishing content with Bengal
weight: 20
type: doc
draft: false
lang: en
...
This guide helps you establish an efficient workflow for creating, reviewing, and publishing content with Bengal. Learn how to manage drafts, use version control effectively, and automate your publishing process.
...
- A Bengal site set up (see [Writer Quickstart](/getting-started/writer-quickstart/))
...
- **[Migrating Content](/guides/migrating-content/)** - Migrate from another SSG
- **[Customizing Themes](/guides/customizing-themes/)** - Customize your site's appearance
- **[CI/CD Setup](/guides/ci-cd-setup/)** - Automate your publishing workflow
