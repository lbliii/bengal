---
title: Build a Blog in 15 Minutes
description: Step-by-step tutorial to create, configure, and customize a personal blog from scratch using Bengal.
weight: 10
type: doc
draft: false
lang: en
...
*   **[Deployment Guide](/guides/deployment/)**: Learn how to host on GitHub Pages or Netlify.
*   **[Theme Customization](/guides/customizing-themes/)**: Deep dive into template overrides.
*   **[Configuration Reference](/about/concepts/configuration/)**: Explore all available settings.
