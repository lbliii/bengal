---
title: CI/CD Setup
description: Set up automated builds, testing, and deployments for your Bengal site using GitHub Actions, GitLab CI, and other platforms
weight: 40
type: doc
draft: false
lang: en
...
This guide shows you how to set up continuous integration and deployment (CI/CD) for your Bengal site. Automate builds, run tests, and deploy to production with GitHub Actions, GitLab CI, or other platforms.
...
- **[Deployment Guide](/guides/deployment/)** - Learn deployment options
- **[Content Workflow](/guides/content-workflow/)** - Set up content publishing workflow
- **[Multi-Environment Setup](/guides/multi-environment/)** - Manage dev/staging/production
