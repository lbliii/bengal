...
keywords: [release, 0.1.7, kida, template engine, patitas, markdown parser, rosettes, syntax highlighting, error codes]
category: changelog
---
...
**Rosettes** provides pure-Python syntax highlighting that works with Python 3.14's free-threading without re-enabling the GIL:
