---
title: Bengal 0.1.3
description: Performance optimization, fast mode, and code quality improvements
type: changelog
date: 2025-10-18
weight: 10
draft: true
...
# Bengal 0.1.3 - Performance & Polish
**Coming Soon**
...
No configuration changes needed. To take advantage of new features:

**Enable Fast Mode** (optional):
```toml
# bengal.toml
[build]
fast_mode = true
...
For maximum performance on large sites:
...
2. **Configure workers** for your CPU:
   ```toml
   [build]
...
Looking ahead to 0.1.4 and beyond:
...
Thanks to everyone testing Bengal and providing feedback. Your input drives these improvements!
