...
description: Plugin hooks and customization points for extending Bengal without modifying core code.
weight: 40
category: meta
...
**Documentation**: See [Content Types](../core/content-types.md)
...
**Documentation**: See [Health Checks](../subsystems/health.md)
...
- [Content Types](../core/content-types.md) - Custom content strategies
- [Rendering](../rendering/rendering.md) - Template and parser customization
- [Health Checks](../subsystems/health.md) - Custom validators
- [Design Principles](../core/design-principles.md) - Extension design patterns
