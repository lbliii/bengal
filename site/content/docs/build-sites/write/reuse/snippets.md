...
category: guide
aliases:
  - /docs/content/reuse/snippets/
aliases:
  - /docs/build-sites/write/reuse/snippets/
  - /docs/content/reuse/snippets/
---
...
1. **Current page's directory** - If you're in `content/docs/build-sites/`, `snippets/warning.md` looks in `content/docs/build-sites/snippets/`
...
:::{seealso}
- [Content Reuse Overview](/docs/build-sites/write/reuse/) — DRY content strategies
- [Filtering](/docs/build-sites/write/reuse/filtering/) — Advanced content queries
:::
