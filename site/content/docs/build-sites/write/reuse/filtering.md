...
category: guide
aliases:
  - /docs/content/reuse/filtering/
aliases:
  - /docs/build-sites/write/reuse/filtering/
  - /docs/content/reuse/filtering/
---
...
:::{seealso}
- [Filter by Multiple Tags](/docs/build-sites/customize/recipes/filter-by-tags/) — Complete cookbook recipe
- [Content Reuse](/docs/build-sites/write/reuse/) — DRY content strategies
- [Templating](/docs/build-sites/customize/templating/) — Template fundamentals
:::
