...
icon: book
aliases:
  - /docs/content/authoring/notebooks/
aliases:
  - /docs/build-sites/write/authoring/notebooks/
  - /docs/content/authoring/notebooks/
---
# Notebooks in Bengal
...
:::{tip}
**New to notebooks?** Follow the [[docs/build-sites/write/authoring/notebooks/setup|Setup Guide]] for a step-by-step walkthrough—add your first notebook, configure Download/Binder/Colab, and override metadata.
:::
...
::::{seealso}
- [[docs/build-sites/write/authoring/code-blocks|Code Blocks]] — Syntax highlighting for code cells
- [[docs/build-sites/write/authoring/math|Math and LaTeX]] — Inline and block equations in markdown cells
