...
weight: 5
aliases:
  - /docs/content/authoring/notebooks/setup/
aliases:
  - /docs/build-sites/write/authoring/notebooks/setup/
  - /docs/content/authoring/notebooks/setup/
---
...
::::{seealso}
- [[docs/build-sites/write/authoring/notebooks|Notebooks overview]] — What gets rendered, metadata, examples
