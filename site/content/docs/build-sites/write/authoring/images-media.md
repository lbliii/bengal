...
icon: image
aliases:
  - /docs/content/authoring/images-media/
aliases:
  - /docs/build-sites/write/authoring/images-media/
  - /docs/content/authoring/images-media/
---
# Images & Media
...
:::{tip}
For page-specific images, use [page bundles](/docs/build-sites/structure/organization/) — put images next to your markdown file and reference them with `./image.png`.
:::
...
- [[docs/build-sites/customize/assets|Asset Pipeline]] — Image optimization
