...
- comparison tables
aliases:
  - /docs/content/authoring/tables/
aliases:
  - /docs/build-sites/write/authoring/tables/
  - /docs/content/authoring/tables/
---
...
- [[docs/build-sites/write/authoring|Authoring Overview]] — Other content authoring features
