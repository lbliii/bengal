...
icon: layers
aliases:
  - /docs/content/authoring/interactive/
aliases:
  - /docs/build-sites/write/authoring/interactive/
  - /docs/content/authoring/interactive/
---
...
See [Code Blocks](/docs/build-sites/write/authoring/code-blocks/) for more options like filenames, custom labels, and line highlighting.
