...
- api links
aliases:
  - /docs/content/authoring/external-references/
aliases:
  - /docs/build-sites/write/authoring/external-references/
  - /docs/content/authoring/external-references/
---
...
- [[docs/build-sites/write/authoring/linking|Linking Guide]] — All linking methods
- [[docs/build-sites/structure/versioning/cross-version-links|Cross-Version Links]] — Link between versions
