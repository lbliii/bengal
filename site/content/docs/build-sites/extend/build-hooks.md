...
weight: 10
aliases:
  - /docs/extending/build-hooks/
aliases:
  - /docs/build-sites/extend/build-hooks/
  - /docs/extending/build-hooks/
---
...
- [Configuration](/docs/ship/configuration/) for all `bengal.toml` options
- [Build Pipeline](https://github.com/lbliii/bengal/tree/main/docs/architecture/core/pipeline/) for understanding when hooks run
