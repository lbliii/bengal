...
weight: 20
aliases:
  - /docs/extending/theme-customization/
aliases:
  - /docs/build-sites/extend/theme-customization/
  - /docs/extending/theme-customization/
---
...
- [Build Hooks](/docs/build-sites/extend/build-hooks/) for CSS preprocessing
- [Configuration](/docs/ship/configuration/) for theme settings
