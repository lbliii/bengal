...
icon: file-text
aliases:
  - /docs/extending/custom-skeletons/
aliases:
  - /docs/build-sites/extend/custom-skeletons/
  - /docs/extending/custom-skeletons/
---
...
- [[docs/examples/sites/skeleton-quickstart|Skeleton YAML Quickstart]] — Copy-paste examples
