...
[[docs/build-sites/write/authoring|Authoring]] and [[docs/build-sites/customize|Theming]] first.
...
- [Configuration](/docs/ship/configuration/) for `bengal.toml` options
