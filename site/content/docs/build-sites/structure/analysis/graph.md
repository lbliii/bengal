...
category: guide
aliases:
  - /docs/content/analysis/graph/
aliases:
  - /docs/build-sites/structure/analysis/graph/
  - /docs/content/analysis/graph/
---
...
- [Analysis System Architecture](https://github.com/lbliii/bengal/tree/main/docs/architecture/subsystems/analysis/) — Technical details and API usage
- [Health Check System](https://github.com/lbliii/bengal/tree/main/docs/architecture/subsystems/health/) — Automated validation with ConnectivityValidator
:::
