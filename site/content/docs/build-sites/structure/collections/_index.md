...
aliases:
  - /docs/build-sites/structure/collections/
  - /docs/content/collections/
---
# Content Collections
...
See [Content Sources](/docs/build-sites/extend/sources/) for GitHub, Notion, REST API loaders.

:::{seealso}
- [Content Sources](/docs/build-sites/extend/sources/) — GitHub, Notion, REST API loaders
:::
