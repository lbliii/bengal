...
title: Component Model Reference
nav_title: Component Examples
description: Exhaustive type, variant, props, cascade, and skeleton examples for Bengal's component model
weight: 21
variant: reference
tags:
- reference
...
- persona-writer
aliases:
  - /docs/content/organization/component-model-reference/
aliases:
  - /docs/build-sites/structure/organization/component-model-reference/
  - /docs/content/organization/component-model-reference/
---

# Component Model Reference

Lookup-oriented examples for every `type`, `variant`, and props pattern. For the
conceptual overview, read [[docs/build-sites/structure/organization/component-model|The Component
Model]] first.

:::{note}
**Do I need this?** Use this page when you know the component model and need a
copy-paste example. New to types and variants? Start with the main guide.
:::
