...
weight: 10
aliases:
  - /docs/content/i18n/quickstart/
aliases:
  - /docs/build-sites/structure/i18n/quickstart/
  - /docs/content/i18n/quickstart/
---
# i18n Quickstart
...
- [[docs/build-sites/structure/i18n/rtl|RTL Layout]] — RTL layout for Arabic/Hebrew
- [[docs/build-sites/structure/i18n/translator-guide|Translator Guide]] — Contributor workflow for translations
