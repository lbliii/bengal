...
- persona-themer
aliases:
  - /docs/theming/templating/
aliases:
  - /docs/build-sites/customize/templating/
  - /docs/theming/templating/
---
# Templating
...
only write Markdown — see [[docs/build-sites/write/authoring|Authoring]]. New to templates?
...
:::{card} Kida How-Tos
:icon: code
:link: /docs/build-sites/customize/templating/kida/
:description: Common Kida tasks and patterns
:::{/card}

:::{card} Migrate from Jinja2
:icon: arrow-right
:link: /docs/build-sites/customize/templating/kida/migration/from-jinja/
...
See [Bring Your Own Template Engine](/docs/build-sites/customize/templating/custom-engine/) for the complete guide.
