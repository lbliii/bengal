...
- persona-themer
aliases:
  - /docs/theming/templating/kida/
aliases:
  - /docs/build-sites/customize/templating/kida/
  - /docs/theming/templating/kida/
---
...
- [Operators Guide](/docs/build-sites/customize/templating/kida/syntax/operators/) — Pipeline, optional chaining, and null coalescing
- [Template Functions](/docs/reference/template-functions/) — Available filters and functions
- [Migrating from Jinja2](/docs/build-sites/customize/templating/kida/migration/from-jinja/) — Step-by-step migration guide
