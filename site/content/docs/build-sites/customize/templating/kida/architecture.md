...
aliases:
  - /docs/theming/templating/kida/architecture/
aliases:
  - /docs/build-sites/customize/templating/kida/architecture/
  - /docs/theming/templating/kida/architecture/
---
...
:::{seealso}
- [Performance](/docs/build-sites/customize/templating/kida/performance/) — Benchmarks and optimization strategies
- [Overview](/docs/build-sites/customize/templating/kida/) — Why Kida exists
:::
