...
- migration
aliases:
  - /docs/theming/templating/kida/migration/from-jinja/
aliases:
  - /docs/build-sites/customize/templating/kida/migration/from-jinja/
  - /docs/theming/templating/kida/migration/from-jinja/
---
...
- [Create Custom Template](/docs/build-sites/customize/templating/kida/create-custom-template/) — Build new templates with Kida

:::{seealso}
- [Template Functions](/docs/build-sites/customize/templating/functions/) — Available filters and functions
- [Performance Guide](/docs/ship/performance/) — Performance benefits of Kida
