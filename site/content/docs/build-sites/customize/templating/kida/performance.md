...
category: reference
aliases:
  - /docs/theming/templating/kida/performance/
aliases:
  - /docs/build-sites/customize/templating/kida/performance/
  - /docs/theming/templating/kida/performance/
---
...
Fragment cache uses a global TTL configured in `bengal.toml` (or `config/_default/`). All cached fragments share the same expiration time. See [Fragment Caching](/docs/build-sites/customize/templating/kida/caching/fragments/) for configuration details.
...
- [Fragment Caching](/docs/build-sites/customize/templating/kida/caching/fragments/) — Detailed caching guide with TTL configuration
- [Automatic Block Caching](/docs/build-sites/customize/templating/kida/caching/automatic/) — How site-scoped blocks are cached automatically
