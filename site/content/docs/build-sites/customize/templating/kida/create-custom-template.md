...
category: guide
aliases:
  - /docs/theming/templating/kida/create-custom-template/
aliases:
  - /docs/build-sites/customize/templating/kida/create-custom-template/
  - /docs/theming/templating/kida/create-custom-template/
---
...
- [Add Custom Filters](/docs/build-sites/customize/templating/kida/add-custom-filter.md) — Extend Kida with your own filters
- [Use Pattern Matching](/docs/build-sites/customize/templating/kida/syntax/operators/#pattern-matching) — Clean up conditional logic
- [Cache Fragments](/docs/build-sites/customize/templating/kida/caching/fragments/) — Improve performance

:::{seealso}

- [Kida Syntax Reference](/docs/reference/kida-syntax/) — Complete syntax documentation
- [Template Functions](/docs/build-sites/customize/templating/functions/) — Available filters and functions
:::
