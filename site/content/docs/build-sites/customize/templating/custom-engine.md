...
category: guide
aliases:
  - /docs/theming/templating/custom-engine/
aliases:
  - /docs/build-sites/customize/templating/custom-engine/
  - /docs/theming/templating/custom-engine/
---
...
- [Engine Protocol Reference](https://github.com/lbliii/bengal/tree/main/docs/architecture/rendering/) — Full protocol details
- [Kida Source Code](https://github.com/lbliii/bengal/tree/main/bengal/rendering/kida/) — Reference implementation

:::{seealso}
- [Add Custom Filter](/docs/build-sites/customize/templating/kida/add-custom-filter/) — Add functions to existing engines
- [Extension Points](https://github.com/lbliii/bengal/tree/main/docs/architecture/meta/extension-points/) — Other customization options
:::
