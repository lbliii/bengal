...
- responsive
aliases:
  - /docs/theming/templating/image-processing/
aliases:
  - /docs/build-sites/customize/templating/image-processing/
  - /docs/theming/templating/image-processing/
---
# Image Processing
...
:::{seealso}
- [[docs/build-sites/write/authoring/images-media|Images & Media]] — Markdown syntax for images
- [[docs/reference/template-functions/seo-image-functions|Image Functions Reference]] — Complete function reference
:::
