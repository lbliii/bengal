...
category: cookbook
aliases:
  - /docs/theming/recipes/reading-time/
aliases:
  - /docs/build-sites/customize/recipes/reading-time/
  - /docs/theming/recipes/reading-time/
---
...
- [Template Functions](/docs/build-sites/customize/templating/functions/) — All filters
- [List Recent Posts](/docs/build-sites/customize/recipes/list-recent-posts/) — Include reading time in post lists
