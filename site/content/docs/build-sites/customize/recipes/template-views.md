...
category: cookbook
aliases:
  - /docs/theming/recipes/template-views/
aliases:
  - /docs/build-sites/customize/recipes/template-views/
  - /docs/theming/recipes/template-views/
---
...
:::{seealso}
- [Template Functions](/docs/build-sites/customize/templating/functions/) — All available filters
- [OpenAPI Autodoc](../../extend/sources/autodoc.md) — Generating API docs
- [Taxonomy fields](../../structure/organization/frontmatter.md#taxonomy-fields) — Tags, categories, and custom taxonomies
:::
