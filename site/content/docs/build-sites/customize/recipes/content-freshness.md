...
category: cookbook
aliases:
  - /docs/theming/recipes/content-freshness/
aliases:
  - /docs/build-sites/customize/recipes/content-freshness/
  - /docs/theming/recipes/content-freshness/
---
...
```kida
{% let freshness = 'fresh' if page.age_days < 30
...
{% let recently_updated = site.pages
...
```kida
{% let needs_review = page.age_months > 6 and not page.metadata.reviewed_date %}
