...
category: cookbook
aliases:
  - /docs/theming/recipes/featured-posts/
aliases:
  - /docs/build-sites/customize/recipes/featured-posts/
  - /docs/theming/recipes/featured-posts/
---
...
- [List Recent Posts](/docs/build-sites/customize/recipes/list-recent-posts/) — Recent posts pattern
- [Filter by Tags](/docs/build-sites/customize/recipes/filter-by-tags/) — Tag-based filtering (including `is featured` test)
