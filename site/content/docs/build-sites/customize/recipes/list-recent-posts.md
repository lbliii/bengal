...
category: cookbook
aliases:
  - /docs/theming/recipes/list-recent-posts/
aliases:
  - /docs/build-sites/customize/recipes/list-recent-posts/
  - /docs/theming/recipes/list-recent-posts/
---
...
:::{seealso}
- [Template Functions](/docs/build-sites/customize/templating/functions/) — All filter options
- [Group by Category](/docs/build-sites/customize/recipes/group-by-category/) — Organize posts by category
:::
