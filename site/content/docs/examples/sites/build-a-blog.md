...
category: tutorial
aliases:
  - /docs/tutorials/sites/build-a-blog/
aliases:
  - /docs/examples/sites/build-a-blog/
  - /docs/tutorials/sites/build-a-blog/
---
...
*   **[[docs/ship/deployment|Deployment Guide]]**: Learn how to host on GitHub Pages or Netlify.
*   **[[docs/build-sites/customize/themes/customize|Theme Customization]]**: Deep dive into template overrides.
*   **[[docs/ship/configuration|Configuration Reference]]**: Explore all available settings.
