---
title: Migrate Content from Other SSGs
...
- Check [Content Organization](/docs/about/concepts/content-organization/) for structure details
- Review [Configuration](/docs/about/concepts/configuration/) for config options
- See [Getting Started](/docs/getting-started/) for basics

## Next Steps

- **[Content Workflow](/docs/guides/content-workflow/)** - Set up your content creation workflow
- **[Customizing Themes](/docs/guides/customizing-themes/)** - Customize your site's appearance
- **[Deployment](/docs/guides/deployment/)** - Deploy your migrated site
