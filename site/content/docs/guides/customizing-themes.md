...
description: Customize existing themes without breaking updates, override templates, and extend theme functionality
weight: 30
draft: false
lang: en
...
- [Themer Quickstart](/docs/getting-started/themer-quickstart/) completed
...
- **[Themer Quickstart](/docs/getting-started/themer-quickstart/)** - Learn theme basics
- **[Rendering System](/docs/reference/architecture/rendering/)** - Understand template rendering
- **[Asset Pipeline](/docs/about/concepts/assets/)** - Optimize CSS and JavaScript
