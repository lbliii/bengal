...
:::{tip}
Pin your version in `pyproject.toml` or `requirements.txt` (e.g., `bengal==0.1.10`) to prevent unexpected upgrades. Upgrade deliberately by reviewing the changelog first.
:::
