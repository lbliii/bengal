...
[[docs/content/authoring/linking-reference|Linking Reference]].
:::
...
- [[docs/content/authoring/linking-reference|Linking Reference]] — template functions and path resolution
- [[docs/content/authoring/external-references|External References]] — Python stdlib, NumPy, cross-site links
- [[docs/content/validation|Content Validation]] — link validation with `bengal check`
