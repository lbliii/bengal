...
[[docs/content/authoring/code-blocks-reference|Code Blocks Reference]].
:::
...
:::{seealso}
- [[docs/content/authoring/code-blocks-reference|Code Blocks Reference]] — code-tabs and syntax themes
