---
title: Kida Syntax Reference (Detailed)
nav_title: Kida Syntax Details
description: Exhaustive Kida filter, operator, caching, and migration reference
weight: 61
draft: false
lang: en
tags:
...
Lookup-oriented reference for built-in filters, caching, operators, tests,
configuration, and Jinja2 migration patterns.

:::{note}
**Do I need this?** Use when you know basic Kida syntax and need a specific
filter or operator. For syntax fundamentals, read
[[docs/reference/kida-syntax|Kida Syntax]] first.
:::
## Built-in Filters
