...
- [Extension Points](/docs/reference/architecture/meta/extension-points/) — Using protocols for customization
- [Custom Template Engine](/docs/theming/templating/custom-engine/) — Implementing TemplateEngine
- [Object Model](/docs/reference/architecture/core/object-model/) — PageLike and SectionLike implementations
