...
category: how-to
aliases:
  - /docs/content/validation/validate-and-fix/
aliases:
  - /docs/ship/validate/validate-and-fix/
  - /docs/content/validation/validate-and-fix/
---
...
see [[docs/ship/validate/validate-and-fix-reference|Validation Reference]].
:::
...
:::{seealso}
- [[docs/ship/validate|Validation Overview]] — hub and built-in checks
- [[docs/ship/validate/validate-and-fix-reference|Validation Reference]] — auto-fix, custom validators, config
:::
