...
aliases:
  - /docs/building/configuration/capabilities/
aliases:
  - /docs/ship/configuration/capabilities/
  - /docs/building/configuration/capabilities/
---
...
[[docs/build-sites/extend/plugins|Plugin Development]] for author guidance and the
`examples/capability-demo/` reference package for an end-to-end sample.

## Related

- [[docs/build-sites/customize/capabilities-vs-theme|Capabilities vs theme features]]
- [[docs/build-sites/extend/plugins#runtime-capabilities-diagram--math-vendors|Authoring a capability package]]
