...
category: reference
aliases:
  - /docs/building/configuration/reference/
aliases:
  - /docs/ship/configuration/reference/
  - /docs/building/configuration/reference/
---
...
- [[docs/ship/configuration/profiles|Build Profiles]] — Environment-specific config
- [[docs/ship/configuration/variants|Multi-Variant Builds]] — Build different site variants
