...
:::{seealso}
- [[docs/ship/configuration|Configuration]] — environment-specific settings
- [[docs/ship/configuration/variants|Multi-Variant Builds]] — OSS vs Enterprise, brand variants
- [[docs/ship/performance|Performance]] — optimize build times
- [[docs/ship/validate|Validation]] — health checks before you ship
:::
